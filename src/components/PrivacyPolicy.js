  ...
  return (
    <>
      <Container>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to makebucks.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to makebucks, accessible from{" "}
              <a
                href="https://www.makebucks.in"
                target="_blank"
                rel="noreferrer"
              >
                https://www.makebucks.in
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: makebucks.in@gmail.com</li>
        </ul>
      </Container>
    </>
  );
