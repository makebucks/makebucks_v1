...
const TaxFiling = () => {
  return (
    <>
      <StyledHeader>
        <H2>
          File your<StyledSpan> tax on time.</StyledSpan>
        </H2>
      ...
      <StyledCardContainer>
        <StyledSecondCard>
          <Card>
            ...
            <CardPara>
              We help you to file taxes for individuals & for business
            </CardPara>
            <StyledCardSpan>₹ 199</StyledCardSpan>
            <StyledAmount>
              ₹ Free{" "}
              <STyledAmountSpan>/ only for consultation</STyledAmountSpan>
            </StyledAmount>
            ...
            <BottomButtons>
              ...
              <a
                className="cal"
                href="http://www.cal.com/makebucks"
                target="_blank"
                rel="noreferrer"
              >
