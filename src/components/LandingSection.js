    ...
    return (
        ...
        <StyledHeader>
            ...
            <StyledContainer>
                ...
                <StyledPara>Learn how to trade efficiently from absolute basics to expert level. we will help you to become independent trader.</StyledPara>
                <Link to="wcu" smooth={true} offset={-50} duration={500}><button>Learn more</button></Link>
            </StyledContainer>
            </StyledHeader>
