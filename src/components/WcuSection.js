  ...
  return (
    <>
      <StyledWCUSection id="wcu">
        <H2>Why choose us.</H2>
        <StyledPara>
          Here are some highlights about our goals & offerings
        </StyledPara>
        ...
        <CardSection>
          ...
          <MiddleCard>
            <Learn>
              <H4>
                Learn with <StyledSpan>makebucks</StyledSpan>
              </H4>
              <StyledTagLine>
                We are on a mission to make every common people to a profitable
                trader and the social connection to support and build a strong
                financial future in the community.{" "}
              </StyledTagLine>
            </Learn>
          </MiddleCard>
          <SmallCard>
